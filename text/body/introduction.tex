...
\begin{description}
    \item[\Cref{sec:review}] is a literature review of the state of the art in engine and component simulation, including the basic elements to model the behaviour of compressors, turbines and engines, instabilities in engine systems and the numerical methods needed to bring these models to life. It is kept relatively brief and plenty of references are provided.
    \item[\Cref{sec:methods}] develops the methods for simulating a gas turbine engine and its components. It contains tables summarizing the nonlinear system associated with each model and the specifics of the numerical methods used to simulate each aspect of the models. In the end, the engine for which these models were applied is described.
