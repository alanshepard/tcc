...
Compressor().plot_map(ax[0], P0_max=3, samples=samples)
...
wline = e.working_line(np.arange(600,1033,50))
...
mark_inset(ax[1], axins, loc1=2, loc2=4, facecolor="none", edgecolor="0.5", linewidth=0.6)
axins.set_xlabel('')
axins.set_ylabel('')

ax[0].set_ylim(1,3)
ax[0].set_title('Compressor', fontname='Helvetica')
ax[1].set_ylim(1,3)
